...
public class HyriRunnerStatistics extends HyriPlayerData {

    private final Map<RunnerGameType, Data> data;

    public HyriRunnerStatistics() {
    ...
    public void update(IHyriPlayer account) {
        account.addStatistics("runner", this);
        account.update();
    }
    ...
    public static HyriRunnerStatistics get(IHyriPlayer account) {
        HyriRunnerStatistics statistics = account.getStatistics("runner", HyriRunnerStatistics.class);

        if (statistics == null) {
            statistics = new HyriRunnerStatistics();
    ...
    public static HyriRunnerStatistics get(UUID playerId) {

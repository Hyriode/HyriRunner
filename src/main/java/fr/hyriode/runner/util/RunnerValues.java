...
public class RunnerValues {
    ...
    public static final ValueProvider<Integer> BORDER_INITIAL_SIZE = new ValueProvider<>(1400).addModifiers(new HostValueModifier<>(1, Integer.class, "border-initial-size"));
    ...
    public static final ValueProvider<Double> BORDER_SPEED = new ValueProvider<>(7.0D).addModifiers(new HostValueModifier<>(1, Double.class, "border-speed"));
